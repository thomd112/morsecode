document.addEventListener("DOMContentLoaded", function() {
    ...
    const letters = [
        { "alphabet": "A.-", "phrase": "<strong>a</strong> <em>part</em>", "sound": "A_morse_code.ogg", "id": 1 },
        { "alphabet": "B -...", "phrase": "<em>bob</em> <strong>is the man</strong>", "sound": "B_morse_code.ogg", "id": 2 },
        { "alphabet": "C-.-.", "phrase": "<em>co</em> <strong>ca</strong> <em>co</em> <strong>la</strong>", "sound": "C_morse_code.ogg", "id": 3 },
